(function () {
    ...
    */
    ...
    brasil.unshift('Pará','Amazônia','Acre');
    console.log(brasil);
    ...
    */
    ...
    var isAllStatesGreatThan7letters = brasil.every(function (estado) {
        return estado.length > 7;
    });
    console.log(isAllStatesGreatThan7letters ? 'Sim, todos os estados tem mais de 7 letras!' : 'Nem todos os estados tem mais de 7 letras!');
    ...
    */
    ...
    isCearaInBrasil = brasil.some(function (estado) {
        return estado == 'Ceará';
    });
    console.log(isCearaInBrasil ? 'Ceará está incluído!' : 'Ceará não foi incluído :(');
