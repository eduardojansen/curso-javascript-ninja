(function(){
    ...
    */
    ...
    // var r = calculator(2,3);
    // r(function(a,b){console.log('teste'+a+''+b)})
    ...
    */
    var subtraction = calculator(21,4);
    var multiplication = calculator(2,44);
    var division = calculator(2,24);
    var mod = calculator(21,40);
